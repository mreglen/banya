...
function Booking() {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    if (isSubmittingRef.current || isLoading || isSubmitting || showSuccess) return;
    if (!validate()) return;
    ...
    try {
      ...
      toast.error(err?.data?.detail || 'Не удалось отправить заявку');
    } finally {
        ...
        <div className="bg-white rounded-3xl shadow-xl p-8 md:p-10 border border-gray-100">
          {showSuccess ? (
            <div className="text-center py-8 sm:py-12 space-y-5">
              ...
              <div>
                <h3 className="text-2xl font-medium text-gray-900 mb-2">Заявка отправлена</h3>
              ...
              <button
                type="button"
                onClick={resetForm}
                className="px-8 py-3 rounded-xl text-lg font-medium bg-green-600 hover:bg-green-700 text-white transition-all"
              >
            ...
            <form onSubmit={handleSubmit} className="space-y-8">
              ...
              <div>
                ...
                <select
                  ...
                  disabled={isLoadingBaths || isBusy}
                >
              ...
              <div>
                <div className="flex items-center justify-between gap-3 mb-2">
                  ...
                  <button
                    ...
                    disabled={isBusy}
                    className="text-xs px-3 py-1.5 rounded-lg bg-gray-100 text-gray-700 hover:bg-gray-200 transition disabled:opacity-50"
                  >
                    Сбросить
                  </button>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <select
                      ...
                      disabled={!formData.date || !formData.bath_id || isBusy}
                    >
                  ...
                  <div>
                    ...
                    <select
                      ...
                      className="w-full px-4 py-3 border border-gray-300 rounded-xl bg-white focus:ring-2 focus:ring-green-500"
                      disabled={!selectedStartSlot || isBusy}
                    >
