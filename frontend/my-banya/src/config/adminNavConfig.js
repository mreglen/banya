...
export const MOBILE_MORE_ITEMS = [
  ...
  { path: '/admin/company/user', label: 'Сотрудники', section: 'company', permission: 'staff:view' },
  { path: '/admin/company/client', label: 'Клиенты', section: 'company', permission: 'clients:view' },
  { path: '/admin/company/partner', label: 'Поставщики', section: 'company', permission: 'partners:view' },
  { path: '/admin/company/organization', label: 'Организация', section: 'company' },
